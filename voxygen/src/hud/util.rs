...
pub fn ability_image(imgs: &img_ids::Imgs, ability_id: &str) -> image::Id {
    match ability_id {
        ...
        "common.abilities.sword.basic_dual_double_slash" => imgs.sword_basic_double_slash,
        "common.abilities.sword.heavy_dual_double_slash" => imgs.sword_heavy_double_slash,
        "common.abilities.sword.agile_dual_double_slash" => imgs.sword_agile_double_slash,
        "common.abilities.sword.defensive_dual_double_slash" => imgs.sword_defensive_double_slash,
        "common.abilities.sword.crippling_dual_double_slash" => imgs.sword_crippling_double_slash,
        "common.abilities.sword.cleaving_dual_double_slash" => imgs.sword_cleaving_double_slash,
